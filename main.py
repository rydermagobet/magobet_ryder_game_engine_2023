...
# define colors
# Changed the green plat to pink
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
RED = (255, 0, 0)
PINK = (248, 152, 128)
...
class Player(Sprite):
    ...
    def update(self):
        ...
        # friction changed some -0.2 to -0.5 allowing a slower eaiser pace.
...
# instantiate classes
# Changed player plat to 90 from 150, shifting bottem plat left some pixles
player = Player()
plat = Platform(90, 300, 100, 30)
